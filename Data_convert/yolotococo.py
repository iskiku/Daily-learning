"""
@Time ： 2024/9/12 11:33
@Author ： jtch
"""
# YOLO目标检测格式 转换为 coco格式
# 前提是YOLO已经划分好数据集了
# 得到instances_train2017.json等文件
import os
import cv2
import json
...
parser.add_argument('--root_dir', default=r'D:\YOLO-BBOX', type=str,
                    help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str, default='D:\YOLO-BBOX\instances_test2017.json',
